...
export default function MovieDetailPage({
  ...
  if (error || !movie) {
    return (
      <div className="max-w-md mx-auto px-4 py-24 text-center">
        ...
        <p className="text-sm text-zinc-400 mb-6">{error || "Could not retrieve the requested film."}</p>
        <Link
          href="/movies"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-white text-xs font-semibold"
        >
  ...
  // Filter showtimes by selected date if set
  ...
  // Extract unique dates from all showtimes for date picker
